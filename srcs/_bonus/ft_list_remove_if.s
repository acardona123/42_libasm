...
;	 erase al the elements of the list which data compared to data_ref with cmp gives 0. The removed data will bee freed using free_fct.
...
ft_list_remove_if:
	;prologue: save callee-saved reg (if used only)
	push rbp
	mov rbp, rsp
	push r12
	push r13
